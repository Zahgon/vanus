...
func NewRenderArrayAction() action.Action { _ = "STUB: not implemented"; return *new(action.Action) }

func (a *renderArrayAction) Init(args []arg.Arg) error { _ = "STUB: not implemented"; return nil }
