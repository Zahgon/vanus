...
func NewConditionIfAction() action.Action { _ = "STUB: not implemented"; return *new(action.Action) }

func (a *conditionIfAction) Init(args []arg.Arg) error { _ = "STUB: not implemented"; return nil }
