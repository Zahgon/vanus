...
func NewDuplicateAction() action.Action { _ = "STUB: not implemented"; return *new(action.Action) }

func (a *duplicateAction) Init(args []arg.Arg) error { _ = "STUB: not implemented"; return nil }
