...
func NewRenameAction() action.Action { _ = "STUB: not implemented"; return *new(action.Action) }

func (a *renameAction) Init(args []arg.Arg) error { _ = "STUB: not implemented"; return nil }
